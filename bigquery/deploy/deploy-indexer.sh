...
gke_cluster_zone=$(gcloud container clusters list | grep elasticsearch-cluster-test | awk '{print $2}')
gcloud container clusters get-credentials elasticsearch-cluster-test --zone ${gke_cluster_zone}
